...
`HS-Offline-Tracker` is developed as a submodule of the
...
- **This module's guide:** [`../docs/submodules/HS-Offline-Tracker/instructions.md`](../docs/submodules/HS-Offline-Tracker/instructions.md) —
  [view on GitHub](https://github.com/falorfrozen-cmd/hero-siege-offline-toolkit/blob/main/docs/submodules/HS-Offline-Tracker/instructions.md)
